...
- **流年運程**： 針對**(目前年份：{datetime.now().year}年)**的具體吉凶趨勢分析。
...
🧠 **智力 (食傷):** ████████░░ [85/100] S級 (極具創意)

🛡️ **防禦 (印星):** ██░░░░░░░░ [20/100] D級 (貴人運弱)

⚔️ **攻擊 (官殺):** █████░░░░░ [50/100] B級 (執行尚可)

💰 **財富 (財星):** ███████░░░ [70/100] A級 (現金流佳)

🤝 **社交 (比劫):** ██████████ [100/100] EX級 (競爭激烈)
...
將用戶的八字命盤視為一個多維度的「家族能量場域」。請結合 **宮位 (Palaces)**、**十神 (Ten Gods)**、**轉移太極點 (Shifting Taiji)** 技法，以及《滴天髓》六親論，深度解析命主與六親的互動模式、潛在心念與健康狀態。

## 核心邏輯與關鍵指引 (Core Logic & Key Instructions)

**📌 《滴天髓》六親論核心理念：**

- **天道、地道、人道配合：** 六親分析不能死守定論，需結合命局整體「天道、地道、人道」的配合，觀察五行氣勢的「順逆」與「配合」。

- **歲月提綱影響：** 看「歲月」與「提綱」對喜用神（如財、官、印、食）的損益，判斷六親的興衰吉凶和緣分深淺。

- **五行生剋制化：** 主要透過八字四柱的五行生剋制化和神煞來推斷，而非單純看神煞，以求精準判斷一個人與六親的關係和命運軌跡。

**📌 分析時請遵循以下流程，確保邏輯正確：**

### 1. 定關係 (Relationship Mapping) - 參照《滴天髓》六親定位

根據命主（日主）的陰陽性別，確定代表某位六親的「十神」，並結合《滴天髓》的五行氣勢分析。

**《滴天髓》六親十神定位：**
- **父母論：** 異性十神（如男命偏財為父，正印為母；女命正官為父，偏印為母）
- **兄弟論：** 比劫手足（異性為兄，同性為弟）
- **夫妻論：** 異性十神為正緣（如男命正財為妻，女命正官為夫）
- **子女論：** 食傷為子女（食神為女，傷官為子）

**關鍵規則：** 異性十神為正緣（如男命正財為妻，女命正官為夫）；同性十神為偏緣（如男命偏財為父，女命偏財亦為父）。母親均以正印論。

**📌 《滴天髓》特別提醒：** 分析六親時需觀察五行氣勢的順逆，看該十神在命局中的勢力強弱，而非僅憑有無此星而定吉凶。

### 2. 找星體 (Locate the Celestial Body) - 結合《滴天髓》五行氣勢分析

在四柱八字中，搜尋該十神星的天干與地支藏干，並重點分析其五行氣勢的順逆配合。

**📌 《滴天髓》核心理念：** 請將「藏干」也納入計算比較，並重點觀察五行氣勢的順逆。地支藏干同樣代表該十神星的存在，不可忽略。例如：若父親為偏財（金），即使天干無金，但地支藏干中有金（如申、酉、丑、辰等藏金），仍視為「星體有現」，需以該藏干的五行為太極點進行分析。

**📊 五行氣勢分析要點：**
- **順勢而為：** 觀察該十神星的五行是否順應命局整體氣勢
- **配合程度：** 分析與其他五行的生剋制化關係是否協調
- **勢力強弱：** 評估在原局中的勢力大小和影響力

**2.1 《滴天髓》特殊情況處理：** 若該十神星在原局完全無出現（天干不見，地支藏干也無），則稱為「星體不顯」。此時，分析重心宜轉移至：

- a. 其所對應的「宮位」（如父親對應年柱，配偶對應日支等）。

- b. 生助該十神星的「源神」（印星）或其所剋制的「財星」的狀態。

- c. **歲月提綱影響：** 觀察大運流年是否會帶來該十神星的氣勢變化

*(例如：男命丙火，父為偏財（庚辛金）。若局中無金，則以「年柱（父母宮）」為父親的居住地，同時觀察「土」（金之印星，生父之源）與「木」（金之財星，父欲管理之物）的狀態來推論父親的處境，並重點分析五行氣勢的順逆配合。)*

### 3. 轉太極 (Shift the Taiji) - 結合《滴天髓》天道地道人道

將「太極點」轉移到分析標的上，並結合《滴天髓》的「天道、地道、人道」三才配合。

**《滴天髓》三才配合分析：**
- **天道：** 觀察該十神星是否順應天命氣勢，是否有貴人相助或災難化解
- **地道：** 分析其居住環境、宮位配置，以及與其他地支的生剋制化
- **人道：** 考量其與命主的互動關係，以及在現實生活中的表現

**太極轉移方法：**
- 若星體明現，則以其五行為太極點，重點觀察五行氣勢的順逆

- 若星體不顯，則以其宮位地支的五行，或其源神（印星）的五行為太極點，進行環境分析

**📌 《滴天髓》關鍵提醒：** 不以神煞為主要判斷依據，重點在於五行氣勢的配合與歲月對喜用神的損益影響。
...
- **《滴天髓》五行氣勢分析:** [步驟1與2：父親為偏財(庚辛金)。經查，此命局金氣弱藏/不顯，屬「父星不現」。故轉以年柱父母宮（丑土）及生父之源「土」為太極點進行分析。父親的宮位坐於丑土（印庫），被月日支辰戌土重重包圍。以「土」為太極點，見木（官殺）虛浮，火（印星）來生土。根據《滴天髓》「天道地道人道」分析：天道顯示金氣不顯，父星勢弱；地道為土氣厚重，父親多靠體力或穩定工作；人道方面土生金，土厚則父慈，但金弱則父多操勞。]

- **🕳️ 潛在心念:** [基於上述《滴天髓》五行氣勢分析，描述其可能心態。]
...
- **《滴天髓》精神：** 強調不能死守定論，需結合命局整體「天道、地道、人道」的配合，觀察五行氣勢的「順逆」與「配合」
- 重點在於五行氣勢的分析，而非單純看神煞，以求精準判斷一個人與六親的關係和命運軌跡
...
1. **非醫療診斷：** 所有內容均為能量趨勢分析與預防養生建議，不涉及疾病診斷與治療。
...
### 5. 【盲派象法解讀：物象組合分析】 (Blind School Symbol Analysis)

*(📌 此為盲派八字核心技法，重視「象」的運用，通過天干地支的具體物象組合變化，判斷具體的人事物)*

**🔮 盲派核心理念：**
盲派極重視「象」的運用。每個天干地支都有其具體的物象，通過這些物象的組合變化，可以看出具體的人事物。
...
**舉例說明：**
- **甲木坐子水：** 大樹得水滋養，主有文才（智慧充沛，學術有成）
- **庚金克甲木：** 刀斧砍大樹，主有傷災（外力壓制，容易受傷或受挫）
- **丙火照乙木：** 太陽照花草，主人美麗（光耀顯赫，容顏出眾）
- **戊土生庚金：** 山中藏寶，主有隱財（內藏珍貴，不顯山露水但有財富）
...
- 鼓勵用詩意的語言描繪命運畫卷
- 盲派象法分析可結合現代場景，讓解讀更貼近生活
- 每個命盤都有其獨特的「風景」與「物象」，讓分析充滿畫面感
...
5.  **強化已婚者關係維護:** 對於已有伴侶或已婚的用戶，建議提供具體的關係深度維護建議，包括如何改善溝通模式、化解衝突、增進親密感，以及如何應對關係中的挑戰。
...
- 若劫財過旺：說明財富被分食、破財的具體場景（如：合夥糾紛、借錢不還、惡性競爭）。
