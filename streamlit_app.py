...
此口訣為分析順序指引，需通盤綜合判斷，不可機械套用。

### ✅ 主要使用（核心十神）

#### A. 官殺星（正官／七殺）
- **象徵意義**：身份的象徵，制度規範與考核壓力
- **七殺特質**：聰明不過七殺，有勤奮之意，但需配印或被制服、制淨，方可學業有成
- **分析重點**：
  - 官星需配印，七殺也需配印
  - 七殺無製化而兇頑 → 主學歷不高
  - 官殺配印或制淨 → 學業有成
...
- **分析重點**：
  - 印星有做功 → 表示學歷和能力
  - 印星沒有做功 → 表示懶惰、不喜歡學習、不開化
- **特殊情況**：印星太旺時，需財星克印星，反而學習上有進步，會提升學習能力
...
#### D. 傷官
- **象徵意義**：聰明、多才多藝，但不守規、不聽話、頑皮
- **分析重點**：
  - 傷官旺之人一般學歷不會太高（學習階段）
  - **但**：傷官配印做功或官殺星做功 → 都會學有所成
  - 傷官配財星、比劫 → 不會好好學習，會荒廢學業

### ⚠️ 影響學歷的十神（需謹慎分析）

#### E. 財星
- **象徵意義**：慾望之星
- **一般影響**：最忌財星，主上學階段學習心亂，學不進去、貪玩、貪戀異性、貪戀錢財、不思進取
- **結果**：學習成績差，失去上學機會，學歷不會很高
- **例外**：印星太旺時，需財星克印星，反而有利學習

#### F. 比劫星（比肩／劫財）
- **象徵意義**：好運動、好鬥、成群結隊、打架鬥毆、貪玩好耍
- **分析重點**：一般主沒有心思認真學習，不利學業
...
**📌 核心原則：重點看原局（八字），大運對學歷的影響是隨著原局八字的用神和忌神是否受傷、用神和忌神有力無力程度，對學歷的影響力也有所不同。**

請依「有印先看印，印少看食傷，最後看財官，綜合看格局」的順序，描述：

1. **印星分析**（優先）：
   - 印星是否有做功？（有做功 → 表示學歷和能力；無做功 → 表示懶惰、不喜歡學習）
   - 印星強弱與配置
   - 印星太旺時，是否有財星克印？（此情況反而有利學習）

2. **食傷分析**（印少時重點看）：
   - 食神：主思考，好上進
   - 傷官：是否配印做功或官殺做功？（配印或官殺 → 學有所成；配財或比劫 → 荒廢學業）
   - 食傷是否形成「吸收 → 輸出」的順流

3. **官殺分析**：
   - 官星是否配印？七殺是否配印或被制服、制淨？
   - 官殺對日主形成：
     - 🟢 可承接的規範（配印或制淨）
     - 🟡 壓力型要求（有印但需努力）
     - 🔴 無製化而兇頑（學歷不高）
...
4. **財星與比劫影響**：
   - 財星是否為忌神？（忌神 → 學習心亂、貪玩、不利學業）
   - 比劫是否過旺？（過旺 → 好運動好鬥、無心學習）

5. **日主強弱與五行流通**：學習能量是否可持續

📌 **用詞必須是「傾向」「結構上較容易／較費力」**

### ✅ 步驟二：學業關鍵大運與流年（回顧式，輔助分析）

**📌 核心原則：歲運的好壞直接影響學業的成敗。命運是八字命局與歲運（大運和流年）的統一體，不可分割。需結合求學期間的運氣好壞來綜合論斷。**

**重要提醒**：
- 主要看前兩步大運，但重點仍在原局八字
- 大運的影響力取決於原局用神和忌神的狀態
- 即使原局不理想，若求學期間行有利學運，仍可彌補不足
- 即使原局有登科標誌，若求學期間學運不佳，仍可能受阻
...
📌 **僅做「事後合理化解讀」，不做假設性預測。需綜合分析，不可機械套用。**

### ✅ 步驟三：流年觸發點與考試時機（僅標示，不放大）

結合步驟二的大運分析，標出與學業明顯相關的流年：
...
### 🎓 1. 學習結構總覽
- 日主五行 × 學習型態
- 依「有印先看印，印少看食傷，最後看財官，綜合看格局」的順序分析
- 印／食傷／官星的整體配置關係
- 財星與比劫的影響評估
...
### 📚 3. 學習科目傾向分析（參考）
根據五行與十神組合，推測較適合的學習領域：
- **理科類**：庚申戊亥（數學）、申子辰（化學）、申酉+丑（法律）、官殺、金水
- **文科類**：食神（中文/外語）、食傷、木火、寅卯配火
- **特殊領域**：辰戌（數位網路、航程、航線、航太）
...
- 為何順利／為何轉彎（結構性說明）
- **大運流年影響分析**：
  - 求學期間大運是否為喜用神，生助印綬或食傷？
  - 是否形成有利格局（傷食佩印、官印相生、殺印相生等）？
  - 是否有吉神煞出現（文昌、太極、華蓋等）？
  - 是否為調候、通關之神？
  - 忌神是否被克制？
  - 用神和忌神在大運中的狀態如何？
