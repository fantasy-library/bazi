...
g_shens = {
    '天乙':{"甲":'未丑',  "乙":"申子", "丙":"酉亥", "丁":"酉亥", "戊":'未丑', "己":"申子", 
            "庚": "未丑", "辛":"寅午", "壬": "卯巳", "癸":"卯巳"},
    '太极':{"甲":'子午',  "乙":"丑未", "丙":"寅申", "丁":"卯酉", "戊":"辰戌", "己":"巳亥", 
            "庚": "午子", "辛":"未丑", "壬": "申寅", "癸":"酉卯"},
    '金匮':{"甲":'辰',  "乙":"巳", "丙":"未", "丁":"申", "戊":"戌", "己":"亥", 
            "庚": "子", "辛":"丑", "壬": "寅", "癸":"卯"},
    '太阴':{"甲":'丑',  "乙":"寅", "丙":"卯", "丁":"辰", "戊":"巳", "己":"午", 
            "庚": "未", "辛":"申", "壬": "酉", "癸":"戌"},
...
shens_infos = {
    ...
    '太极': "太极贵人：聪明好学，有钻劲，喜文史哲宗教。男命多学术，女命多清雅。",
    '金匮': "金匮贵人：主财库丰厚，有聚财能力，善于理财投资。忌冲破，有库则佳。",
    '太阴': "太阴贵人：主女性助力，贵人相助，温和仁慈，有文学艺术天赋。",
    '将星': "有理想、气度、即从容不迫。",     
    '华盖': "有艺术、水准与命格相关。",
...
days60 = {
    ...
    "丙戌": "天厨贵人日，坐墓，福神财地。\n玉堂厚禄寒门出，金银珠宝西方路。\n日落深潭闯鬼门，金榜题名显双亲。\n生于子月，福寿延，有名有利，地支巳午戌月，富贵双全。申酉月，大富，财团。辰月冲，少年名显。亥月，武职，六品。丑月，一般经济人。辰月，身旺得职，身弱貧賤。",
